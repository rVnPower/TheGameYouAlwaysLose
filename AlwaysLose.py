...
def settings():
    ...
    while True:
        print(
            f"1) Change current operating system settings (Current: {defaultOS})"
        )
    ...
    def Sandbox():
        def PlaySandbox():
            ...
            while True:
                clear()
                print(
                    "You can always break out the game using Ctrl+C.\n______________________________________________________"
                )
                    ...
                    if play1Turn:
                        ...
                        if minNum <= play1Point <= maxNum:
                            ...
                            if totalPoint >= maxPoint:
                                play1Scores += 1
                                print(
                                    f"Player 1 Win! Now you have {play1Scores} points!"
                                )
                            ...
                            print(
                                f"Please choose a number between {minNum} and {maxNum}."
                            )
                            print(
                    ...
                    if play2Turn:
                        ...
                        if minNum <= play2Point <= maxNum:
                            ...
                            if totalPoint >= maxPoint:
                                play2Scores += 1
                                print(
                                    f"Player 2 Win! Now you have {play2Scores} points!"
                                )
                                input("Press any key to continue...")
                                break
                            print(
        ...
        while True:
            clear()
            print(
                "You are free to edit any value in this mode!\n______________________________________________________"
            )
            print(
                f"1) Min Number (Current: {minNum})\n2) Max Number: (Current: {maxNum})\n3) Max Point (Current: {maxPoint})\n4) Play!\n5) Return to menu"
            )
            try:
                Input = int(input(">> "))
            except ValueError:
